                    ...
                    <div className="row">
                        <div className="col-lg-8 col-lg-offset-2">
                            <div className="modal-body justify">
                                ...
                                <p>Effective date: December 20th, 2024</p>
                                <p>Hugo Silva (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates the
                                    https://hugoflsilva.com website
                                ...
                                <p>This page informs you of our policies regarding the collection, use, and disclosure
                                    ...
                                    that data. Our Privacy Policy for Hugo Silva is managed with the help of <a
                                        href="https://privacypolicies.com/free-privacy-policy-generator/">Privacy
                                        Policies</a>.</p>
                                ...
                                <p>We use cookies and similar tracking technologies to track the activity on our Service
                                    ...
                                    and track information and to improve and analyze our Service. You can instruct your
                                ...
                                <h3>Use of Data</h3>
                                <p>Hugo Silva uses the collected data for various purposes:</p>
                                <ul>
                                ...
                                <p>Your information, including Personal Data, may be transferred to — and maintained on
                                    ...
                                    jurisdiction.</p>
                                <p>If you are located outside United Kingdom and choose to provide information to us,
                                    please note that we transfer the data, including Personal Data, to United Kingdom
                                ...
                                <p>Hugo Silva will take all steps reasonably necessary to ensure that your data is
                                ...
                                <p>Hugo Silva may disclose your Personal Data in the good faith belief that such action
                                    is necessary to:</p>
                                <ul>
                                    <li>To comply with a legal obligation</li>
                                    <li>To protect and defend the rights or property of Hugo Silva</li>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p>Google Analytics is a web analytics service offered by Google that tracks and
                                ...
                                <p>Our Service does not address anyone under the age of 18 (&quot;Children&quot;). We do
                                ...
                                <p>If you have any questions about this Privacy Policy, please contact us:
                                    <br/>
                                    By email: me@hugoflsilva.com
                                </p>
                                <button type="button" className="btn btn-primary" data-dismiss="modal"
                                        onClick={closeModal}>
                                    <i className="fa fa-times"></i> Close Privacy Policy
                                </button>
                            </div>
                        </div>
                    </div>
